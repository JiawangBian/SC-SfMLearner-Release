...
OVERSAMPLING_ITERATIONS_TRAIN=250
...
# Checkpoints path.
CHECKPOINTS_PATH="$EXP_RESULTS_ROOT/tests_20.5.2022/checkpoints_r50_depth_trained_on_29_videos_long_experiments_20.5.2022"

# Weights and biases project name.
WANDB_PROJECT_NAME="Exp_""$EXP_NUMBER""_withOverSampling_updateAllParams_singleScale_29_videos"
